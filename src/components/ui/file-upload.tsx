      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-bold text-gray-700 text-base">
            Upload parking citation
          </p>
          <p className="relative z-20 font-sans font-normal text-gray-500 text-base mt-2">
            Drag or drop your PDF, JPG, or PNG file here or click to upload
          </p>
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm text-gray-600 bg-gray-100 shadow-sm"
                    >
